...
我是一名系统架构师与优化研究者，目前在华为担任通信服务团队的技术负责人。我的工作主要围绕基于 Wi-Fi 和蜂窝网络的远场端云通信、基于蓝牙和星闪的设备间通信，以及卫星网络，构建高效可靠的端到端通信系统。我的技术兴趣包括：（1）面向端侧设备之间以及端侧设备与云之间链路的低带宽通信和传输优化；（2）通过软件、硬件与芯片协同实现的低功耗通信。

我于 2024 年通过华为[天才少年计划](https://career.huawei.com/cn/young-genius)加入华为。博士毕业于[清华大学交叉信息研究院（姚班）](https://iiis.tsinghua.edu.cn/)，主要研究大规模网络系统中的优化、控制与博弈方法；本科就读于[清华大学电子工程系](https://www.ee.tsinghua.edu.cn/)和[清华大学新雅书院](https://www.xyc.tsinghua.edu.cn/)，并在[清华大学经济管理学院](https://www.sem.tsinghua.edu.cn/)辅修经济学。
